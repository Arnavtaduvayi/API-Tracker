...
MACOS_RELEASE_URL=${MACOS_RELEASE_URL:-https://github.com/Arnavtaduvayi/API-Tracker/releases/download/v0.1.0-alpha-ui.2/Tethra_0.1.0_aarch64.dmg}
WINDOWS_RELEASE_URL=${WINDOWS_RELEASE_URL:-https://github.com/Arnavtaduvayi/API-Tracker/releases/download/v0.1.0-alpha-ui.2/Tethra_0.1.0_x64-setup.exe}
cd "$REPO_ROOT"
